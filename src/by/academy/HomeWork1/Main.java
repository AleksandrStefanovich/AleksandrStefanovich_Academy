...
public class Main {
    public static void main(String[] args) {
        ...
        result = calc.add((calc.add(calc.square(calc.divide(28, 5),2),calc.multiply(15, 7))),4.1);
        System.out.println(result);
        System.out.println(calc.sqrt(4096,2)); //корень любой степени любого числа

        result = calc.divide(result, 0);    //returns infinity
        System.out.println(result);
        result = calc.divide(20, 0.0d); //returns infinity
        System.out.println(result);
